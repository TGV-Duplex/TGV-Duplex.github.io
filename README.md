...
> - **重要的软件支持**
> - **靠谱的练习资源**
> 方便自己亦是方便他人，网站内容将会**持续更新**，欢迎收藏品鉴！

值得说明的是，我们接触的机电专业知识，它的发展是一个渐进式的过程，这里面有许多人为这一大厦的建成做了很多添砖加瓦的工作，逐步才形成了现在我们看到的这一庞大的机电专业学科群。 \
冰冻三尺非一日之寒，专业里面包含的多知识融合的大杂烩，需要我们活生生地去学，并最终学得活生生的。
...
## **4.推荐读物：《FANUC工业机器人应用技术全集》**

<!--以下开始为《FANUC工业机器人应用技术全集》书本部分内容-->
---
> [!Note] \
> 工业机器人是集机械、电子、控制、计算机、传感器、人工智能等多学科先进技术于一体的机电一体化设备，被称为工业自动化的三大支柱之一。随着社会的进步和劳动力成本的增加，工业机器人在我国的应用已越来越广。 \
> 该书包含了工业机器人入门到FANUC产品应用的全部知识。全书在介绍工业机器人产生、发展、分类及组成、特点、技术参数等入门知识的基础上，针对工业机器人设计、调试、使用、维修人员的需求，对工业机器人本体、谐波减速器、RV减速器、变位器等关键部件的结构原理、安装维护要求进行了深入阐述；对程序结构、编制方法及指令格式进行了全面介绍；对手动与示教操作、程序输入与编辑、程序调整与变换、控制系统参数设定的方法进行了详尽的说明；对机器人安装连接、调整校准、程序调试、系统监控、系统备份以及故障诊断、日常维护等调试维修技术进行了系统阐述。
...
## **5.附件：工业机器人技术竞赛题目下载（适配华航唯实CHL-DS-01平台）**
...
我们的建议：
> [!Note] \
> 在中职课程中，这部分的学科内容叫做《数控加工机械基础》，里面分成了四个组成部分，分别是：项目一、常用金属材料；项目二、常见热处理；项目三、机械传动装置及零部件和项目四、液压和气压传动装置。老实说，这四个项目在大学里面可能会拆分成三门独立的课程（材料和热处理、机械原理、液气压传动），每一门课程可能都需要一个学期或者更久。这里还是以“机械原理”作为命名其实是有一些不太合适的，当然，随着资料的完善，可能会把材料和热处理以及液气压传动部分剥离出来单独成章，敬请期待。
